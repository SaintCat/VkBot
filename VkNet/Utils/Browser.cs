namespace VkNet.Utils
{
    ...
    public class Browser : IBrowser
    {
        ...
        public VkAuthorization Authorize(int appId, string email, string password, Settings settings,VkApi vk, long? captcha_sid = null, string captcha_key = null)
        {
            var authorizeUrl = CreateAuthorizeUrlFor(appId, settings, Display.Wap);
            var authorizeUrlResult = WebCall.MakeCall(authorizeUrl, vk);
            ...
            var loginFormPostResult = WebCall.Post(loginForm, vk);
            ...
            var authorizationFormPostResult = WebCall.Post(authorizationForm, vk);
