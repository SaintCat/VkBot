namespace VkNet.Categories
{
    ...
    public class WallCategory
    {
        ...
        [Pure]
        [ApiVersion("5.9")]
        public ReadOnlyCollection<Post> Get(long ownerId, string domain, out int totalCount, int? count = null, int? offset = null, WallFilter filter = WallFilter.All)
        {
	        ...
	        var parameters = new VkParameters { { "owner_id", ownerId }, {"domain", domain}, { "count", count }, { "offset", offset }, { "filter", filter.ToString().ToLowerInvariant() } };
